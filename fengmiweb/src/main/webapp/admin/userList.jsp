...
<script type="text/javascript">
	...
	function showMsg(list){
		var tbList = $("#tb_list");
		tbList.html("<tr class='tr_head'><td>编号</td><td>邮箱</td><td>姓名</td><td>性别</td><td>类别</td><td>操作</td></tr>");
		var i = 1;
		for(var u in list){
			//声明 tr  td  对象
			var tr = $("<tr></tr>");
			...
			var td6 = $("<td><a href='javascript:userDel("+list[u].id+")' class='btn btn-primary btn-xs'>删除</a></td>");
			//将td 添加到tr中
			tr.append(td1);
			tr.append(td2);
			tr.append(td3);
