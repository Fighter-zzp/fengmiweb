	...
	<div class="panel-body">
	    ...
	    <div class="row" style="margin: 0 auto;">
	    	<c:forEach items="${glist}" var="g" varStatus="i">
		    	<div class="col-sm-3">
				    <div class="thumbnail">
				      <img src="${pageContext.request.contextPath}/assters/images/${g.picture}" width="180" height="180"  alt="小米6" />
				      <div class="caption">
				        <h4>商品名称：<a href="${pageContext.request.contextPath}/getGoodsById?id=${g.id}">${g.name}</a></h4>
				        <p>热销指数：
				        	<c:forEach begin="1" end="${g.star}">
				        		<img src="${pageContext.request.contextPath}/assters/images/image/star_red.gif" alt="star"/>
				        	</c:forEach>
				        </p>
				         <p>上架日期：${g.pubdate}</p>
